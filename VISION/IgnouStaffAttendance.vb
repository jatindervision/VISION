...
Public Class IgnouStaffAttendance
    ...
    Dim sno As Integer
    Private Coursename = ATTIGNOUEMP.TextBox1.Text.Trim()
    ...
    Private Sub IgnouStaffAttendance_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ForIgnoutaffattendance()
        Me.CenterToScreen()
        Me.TopMost = True
    ...
    Private Sub Button8_Click_1(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        Try
            ...
            For i = 0 To ListBox1.Items.Count - 1
                Str = "insert into IGNOUEMPATTENDANCE values('" & ListBox1.Items.Item(i) & "','" & ListBox2.Items.Item(i) & "','" & ListBox3.Items.Item(i) & "','" & ListBox4.Items.Item(i) & "','" & Dates & "')"
