...
Public Class StudentAttendance
    ...
    Dim sno As Integer
    Private Coursename = ATTSTUDENTS.TextBox1.Text.Trim()
        ...
        Try
            If i = 1 And J = 20 Or i = 21 And J = 40 Or i = 41 And J = 60 Or i = 61 And J = 80 Or i = 81 And J = 100 Or i = 101 And J = 120 Or i = 121 And J = 140 Or i = 141 And J = 160 Or i = 161 And J = 180 Or i = 181 And J = 200 Then
                ...
                For i = i - 1 To J - 1 Step 1
                    ...
                    sno = sno + 1
                    ListBox1.Items.Add(ds.Tables("" & Coursename & "").Rows(i)("Id"))
                    ' ListBox1.Items.Add("----")
                    ListBox2.Items.Add(ds.Tables("" & Coursename & "").Rows(i)("Adm_NO"))
                    ' ListBox2.Items.Add("----------------")
                    ListBox3.Items.Add(ds.Tables("" & Coursename & "").Rows(i)("StName"))
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        Try
            ...
            For i = 0 To ListBox1.Items.Count - 1
                Str = "insert into StudentAttendance values('" & ListBox1.Items.Item(i) & "','" & ListBox2.Items.Item(i) & "','" & ListBox3.Items.Item(i) & "','" & ListBox4.Items.Item(i) & "','" & Dates & "')"
