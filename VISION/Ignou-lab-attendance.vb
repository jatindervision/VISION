...
Public Class Ignou_lab_attendance
    Private form13 As IGNOU_LAB_ATT
    Dim Coursename As String = IGNOU_LAB_ATT.TextBox1.Text.Trim()
    Dim Coursecode As String = IGNOU_LAB_ATT.TextBox2.Text.Trim()
    ...
    Private Sub Ignou_lab_attendance_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        FORIGNOULABATT()
        Me.CenterToScreen()
        Me.TopMost = True

        Label15.Text = Coursecode
        Label16.Text = Coursename

        'TextBox23.Text = "DD-MM-YYYY"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ds = New DataSet
        tables = ds.Tables
        da = New OleDbDataAdapter("SELECT * FROM  [" & Coursename & "]", MyConn)
        ...
        Try
            If i = 1 And J = 20 Or i = 21 And J = 40 Or i = 41 And J = 60 Or i = 61 And J = 80 Or i = 81 And J = 100 Or i = 101 And J = 120 Or i = 121 And J = 140 Or i = 141 And J = 160 Or i = 161 And J = 180 Or i = 181 And J = 200 Then
                ...
                For i = i - 1 To J - 1 Step 1
                    ...
                    sno = sno + 1
                    ListBox1.Items.Add(ds.Tables("" & Coursename & "").Rows(i)("SNO"))
                    ' ListBox1.Items.Add("----")
                    ListBox2.Items.Add(ds.Tables("" & Coursename & "").Rows(i)("ENRNO"))
                    ' ListBox2.Items.Add("----------------")
                    ListBox3.Items.Add(ds.Tables("" & Coursename & "").Rows(i)("NAME"))
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        ...
        If TextBox23.Text.Length < 10 Or TextBox23.Text.Length > 10 Then
            MsgBox("Date Format Wrong  MM/DD/2020 ::::means if Date is 4th sept. 2040 then Enter 09/04/2040 ")
            Exit Sub
        End If
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        '  ([SNO] INTEGER,[ENROLL] TEXT(10),[NAME] TEXT(50),[ATTENDANCE] TEXT(10),[DATE_OF_ATTENDANCE]
        If TextBox23.Text.Length < 10 Or TextBox23.Text.Length > 10 Then
        ...
        Dim Rates As String
        Dim Dates As String
        Rates = TextBox23.Text.Trim()
        Dim mm As String
        Dim dd As String
        Dim dd1 As String
        Dim yy As String

        yy = Microsoft.VisualBasic.Right(Rates, 4)
        dd1 = Microsoft.VisualBasic.Right(Rates, 7)
        dd = Microsoft.VisualBasic.Left(dd1, 2)
        mm = Microsoft.VisualBasic.Left(Rates, 2)
        Dates = Convert.ToString(dd & "/" & mm & "/" & yy)
        ...
        Try
            ...
            For i = 0 To ListBox1.Items.Count - 1
                Str = "insert into [" & TCourse & "] values('" & ListBox1.Items.Item(i) & "','" & ListBox2.Items.Item(i) & "','" & ListBox3.Items.Item(i) & "','" & ListBox4.Items.Item(i) & "','" & Dates & "')"
