...
Public Class _13forinputbox
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Course = Convert.ToString(TextBox1.Text.Trim() & "MRORECEIPT")
    ...
    Private Sub _13forinputbox_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        for13()
        Me.CenterToScreen()
        Me.TopMost = True
    End Sub
