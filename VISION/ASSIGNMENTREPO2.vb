...
Public Class ASSIGNMENTREPO2
    ...
    Public Course As String = ASSIGNMENTREPO1.TextBox1.Text.Trim()
    Dim coursename As String
    Dim CCNAME As String
    Private Sub ASSIGNMENTREPO2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ASSIGNPRINT()
        Me.CenterToScreen()
        Me.TopMost = True
